...
<div class="text-zinc-200 flex flex-col items-cneter text-center md:w-4/6">
  ...
  <div class="md:flex md:items-center text-6xl md:text-9xl lg:text-10xl xl:text-12xl 2xl:text-13xl font-bold">
    ...
    <div class="text-sm md:text-9xl lg:text-10xl xl:text-12xl 2xl:text-13xl">{beautifulStr(timeSec)}</div>
  </div>
  ...
  <div class="flex flex-col items-center md:items-start mt-8">
    <div class="text-sm md:text-2xl text-zinc-300">
      Hello,
      {#if editMod}
